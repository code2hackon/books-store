<?php
	...
	function insertIntoCustomers($conn, $user, $pass, $name,$phone){
		$query = "INSERT INTO `customers` (`user`, `pass`, `name`,`phone`) VALUES ('".$user."','".$pass."','".$name."','".$phone."')";
	...
	function userExists($conn,$user){
		$query = "SELECT user from customers where user ='$user'";
